...
{
	$data = array();
	$data["PersonName"]	 	= $_REQUEST["Person_Name"];
	$data["Post"]	 		= $_REQUEST["Post_Name"];
	$data["Person_Mobile"]	= $_REQUEST["Person_Mobile"];
	$data["Contact_Person"]	= $_REQUEST["Contact_Person"];
	$data["ContactPerson_Mobile"]= $_REQUEST["ContactPerson_Mobile"];
	...
	<form name="frmApplication" method="post" onSubmit="return validate()">
		<table border="1" width="319">
			<tr>
				...
				<font color="#FFFFFF" face="Verdana" size="2"><b>Minister / 
				Officer Master</b></font></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right"><font face="Verdana" size="2">Minister/Officer  : </font></td>
				<td><font face="Verdana">
				<input type="text" name="Person_Name" size="25"></font></td>
			</tr>
			<tr>
				<td align="right"><font face="Verdana" size="2">Post :</font></td>
				<td><font face="Verdana">
				<input type="text" name="Post_Name" size="25"></font></td>
			</tr>
			<tr>
				<td align="right"><font face="Verdana" size="2">Contact No:&nbsp;
				</font></td>
				<td><font face="Verdana">
				<input type="text" name="Person_Mobile" size="25"></font></td>
			</tr>
			<tr>
				<td align="right"><font face="Verdana" size="2">Contact Person:</font></td>
				<td><font face="Verdana">
				<input type="text" name="Contact_Person" size="25"></font></td>
			</tr>
			<tr>
				<td align="right"><font face="Verdana" size="2">Contact No:&nbsp;
				</font></td>
				<td><font face="Verdana">
				<input type="text" name="ContactPerson_Mobile" size="25"></font></td>
			</tr>
			<tr>
				<td align="right">&nbsp;</td>
				<td>&nbsp;</td>
		...
		<table border="1" width="100%">
			<tr>
				...
				<td bgcolor="#808080" align="center" width="109"><b>
				<font face="Verdana" size="2" color="#FFFFFF">Post</font></b></td>
				<td width="155" align="center" bgcolor="#808080"><b>
				<font face="Verdana" size="2" color="#FFFFFF">Contact Person</font></b></td>
			...
			<?php
			$sql_person =	" select PersonName, Post, Person_Mobile, Contact_Person, ContactPerson_Mobile, FileCode from  person_master ";
			...
			<tr>
				...
				<td width="180"><?php echo  $row['PersonName'];  ?></td>
				<td width="109"><?php echo  $row['Post'];  ?></td>
				<td><?php echo  $row['Person_Mobile'];  ?></td>
				<td width="28">&nbsp;</td>
				<td width="23">&nbsp;</td>
			</tr>
			<?php
