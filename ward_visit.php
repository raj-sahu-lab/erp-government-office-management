...
<table align=center border="0" width="950" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<form name="frmWard"  id="frmWard" method="post" action="ward.submit.php" onSubmit="return validate()">			
				<table border="0" width="100%" cellpadding="2" cellspacing="3" style="font-family: serif; font-size: 11pt; font-weight:bold">
					...
					<tr>
						...
						<span lang="en-us">Ward Visit Issue Form</span></b></font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						Summary : </span></td>
						<td colspan="3">
						<input type="text" name="problem_summary" size="87" style="width: 555; height: 21"  onchange="setDOB()"></td>
					</tr>
					<tr>
						<td width="292" align="right" valign="top"><span lang="en-us">
						Description : </span></td>
						<td colspan="3">
						<textarea rows="8" name="description" cols="69" style="width: 555; height: 97"></textarea></td>
					</tr>
					<tr>
